...
function validateCommonParams(params) {
  log.logger.debug("FH-MBAAS-CLIENT: validateCommonParams", {params: params});
...
function validateAdminParams(params) {
  log.logger.debug("FH-MBAAS-CLIENT: validateAdminParams", {params: params});
  var missingParam = validateCommonParams(params);
...
function _buildAdminMbaasParams(params) {
  log.logger.debug("FH-MBAAS-CLIENT: _buildAdminMbaasParams", {params: params});
  var basePath;
  ...
  log.logger.debug("FH-MBAAS-CLIENT: _buildAdminMbaasParams", {adminRequestParams: adminRequestParams});
...
function doFHMbaaSRequest(params, cb) {
  ...
  log.logger.debug("FH-MBAAS-CLIENT: doFHMbaaSRequest", {params: params});
...
function adminRequest(params, cb) {
  ...
  log.logger.debug("FH-MBAAS-CLIENT: adminRequest ", {params: params});
  ...
  log.logger.debug("FH-MBAAS-CLIENT: adminRequest ", {fullParams: fullParams});
